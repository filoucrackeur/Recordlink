<?php
namespace Intera\Recordlink\Browser;
...
/**
 * Showing a browser for records links
 */
class RecordBrowser extends AbstractElementBrowser implements ElementBrowserInterface, LinkParameterProviderInterface
{
